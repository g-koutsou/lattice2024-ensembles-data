...
\note[13]{For the OpenLat initiative}
...
nonperturbatively determined using the Schr\"odinger functional
...
here,\par Oakforest-PACS in JCAHPC, Fugaku by RIKEN CCS, \par LUMI-C
and LUMI-G at CSC, Finland,\par Irène Joliot-Curie at Très Grand
Centre de Calcul (TGCC) in Bruyères-le-Châtel, France,\par JUGENE,
JUWELS and JUWELS-Booster at Jülich Supercomputing Centre (JSC),\par
HAWK at Höchstleistungsrechenzentrum Stuttgart (HLRS), Germany,\par
SuperMUC and SuperMUC-NG at Leibniz Rechenzentrum (LRZ) in Garching,
...
Government and the Government of Western Australia, \par Perlmutter at
the National Energy Research Scientific Computing Center (NERSC), CA,
US, and \par the DiRAC Extreme Scaling and Data Intensive services,
which are part of the UKRI Digital Research Infrastructure.
